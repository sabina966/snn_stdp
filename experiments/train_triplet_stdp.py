...
from snn_data.shd import create_dataloaders
...
def main():
    ...
    stdp_params = dict(
        ...
        tau_pre_slow=cfg.tau_pre_slow,
        tau_post_slow=cfg.tau_post_slow,
    )
    ...
    torch.save(
        model.state_dict(),
        "checkpoints/triplet_stdp_model.pt",
    )

    print("\nFinished.")
    print("Weights saved to checkpoints/triplet_stdp_model.pt")
